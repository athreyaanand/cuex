...
public class MarketRatesFragment extends Fragment
{
    ...
    TextView fixPrice;
    ListView listview;
    ListViewAdapter adapter_listview;
    RelativeLayout root_layout;
    View v;
    public static final String BASE_URL = "http://apilayer.net/api/";
    public static final String ENDPOINT = "live";

    public static   ArrayList<CurrencyRates> list_currency_rates_data;
    public static   ArrayList<CurrencyNames> list_currency_names_data;
    public static   ArrayList<CurrencyID> list_currency_id_name;
    ...
    public void add_country_ids_names()  {
        ...
        while(stok.hasMoreElements())
        {
            ...
            list_currency_id_name.add(new CurrencyID(split[2], split2[1]));

        }

        Collections.sort(list_currency_id_name, new Comparator<CurrencyID>() {
            @Override
            public int compare(CurrencyID n1, CurrencyID n2) {
    ...
    public void add_currency_rates()
    {
        ...
        while(stok.hasMoreElements())
        {
            ...
            list_currency_rates_data.add(new CurrencyRates(split[0], split[1]));

        }

        Collections.sort(list_currency_rates_data, new Comparator<CurrencyRates>() {
            @Override
            public int compare(CurrencyRates r1, CurrencyRates r2) {
    ...
    public void add_country_names()
    {
        ...
        while(stoke.hasMoreElements())
        {
            ...
            list_currency_names_data.add(new CurrencyNames(split[0], split[1]));
        ...
        Collections.sort(list_currency_names_data, new Comparator<CurrencyNames>() {
            @Override
        ...
        adapter_listview= new ListViewAdapter(getActivity(),list_currency_names_data,list_currency_rates_data);
